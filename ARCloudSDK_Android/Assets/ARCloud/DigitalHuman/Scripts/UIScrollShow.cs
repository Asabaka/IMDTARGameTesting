...
/// 图片轮播组件
/// </summary>
public class UIScrollShow : UIBehaviour, IBeginDragHandler, IInitializePotentialDragHandler, IDragHandler, IEndDragHandler, ICanvasElement
{
    /// <summary>
    /// 滚动方向H or V
    /// </summary>
    ...
    public virtual int GetBoundaryState()
    {
        ...
        //Debug.Log("left" + left.name+ "l[0].x" + l[0].x + "viewRectXMin"+ viewRectXMin + "r[3].x"+ r[3].x+"----max"+ viewRectXMax + "right" + right.name);
