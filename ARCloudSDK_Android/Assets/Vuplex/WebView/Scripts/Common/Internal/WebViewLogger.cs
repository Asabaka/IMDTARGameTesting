...
namespace Vuplex.WebView.Internal {
    ...
    public static class WebViewLogger {
        ...
        public static void LogFormat(string message, params object[] args) {
            ...
            if (args.Length > 0) {
                //GameObject.Find("ARSession").GetComponent<UIController>().debugInfoText.gameObject.SetActive(true);
                //GameObject.Find("ARSession").GetComponent<UIController>().SetDebugInfo(_format(message) + args[0]);
            }
